...
class PocketOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def start_websocket(self, is_demo):
        ...
        loop.run_until_complete(self.websocket.connect(is_demo))
        loop.run_forever()
    ...
    def connect(self, is_demo):
        ...
        check_websocket, websocket_reason = self.start_websocket(is_demo)
    ...
    async def buyv3(self, *args, **kwargs):
        obj = Buyv3(self)
        return await obj.buy_v3(*args, **kwargs)

    async def getcandles(self, *args, **kwargs):
        ...
        """
        obj = GetCandles(self)
        return await obj.get_candles(*args, **kwargs)
